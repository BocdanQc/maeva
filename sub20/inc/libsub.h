...
/*
*-------------------------------------------------------------------
* $Id: libsub.h,v 1.87 2018/09/24 00:16:42 avr32 Exp $
*-------------------------------------------------------------------
*/
...
* GPIO WDT
*/
#define SUB_GPIO_WDT_EXPIRED    0x01
#define SUB_GPIO_WDT_STOP       0x02
...
int sub_i2c_transfer( sub_handle hndl, int sa, char* wr_buf, int wr_buf_sz, char* rd_buf, int rd_buf_sz );
...
int	sub_gpio_wdt_set( sub_handle hndl, int to_ms, int dir_cfg, int out_cfg );
int	sub_gpio_wdt_get( sub_handle hndl, int* pto_ms, int* pdir_cfg, int* pout_cfg, unsigned char *pflags );
...
/* Sequence */
int sub_sequence( sub_handle hndl, char* seq, char* buf, int* p_sz );
